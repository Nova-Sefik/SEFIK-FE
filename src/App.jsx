    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-page p-6 text-ink">
        <section className="w-full max-w-xl rounded-3xl border border-line bg-surface p-8 shadow-float">
          ...
          <h1 className="mt-2 text-2xl font-medium">Sefik cannot reach the live backend.</h1>
    ...
    <div className="min-h-screen bg-page text-ink lg:grid lg:h-screen lg:grid-cols-[21rem_minmax(0,1fr)_25rem] lg:grid-rows-[auto_auto_minmax(0,1fr)_auto]">
      <header className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-line px-4 py-2.5 lg:col-span-3">
        <div className="mr-auto min-w-52">
          <div className="flex items-center gap-2"><span className="flex h-7 w-7 items-center justify-center rounded-full bg-primary text-sm font-semibold text-white">S</span><div><p className="text-base font-medium leading-tight text-ink">Sefik</p><p className="text-[10px] text-ink-3">AI mobility intelligence for Lisbon</p></div></div>
        </div>
      ...
      <main className="relative order-1 h-[58vh] lg:order-none lg:col-start-2 lg:row-start-3 lg:h-auto"><LiveMap /></main>
      ...
      <div className="hidden lg:absolute lg:left-1/2 lg:top-[4.4rem] lg:z-[600] lg:flex lg:-translate-x-1/2 lg:gap-1 lg:rounded-full lg:border lg:border-line lg:bg-surface lg:p-1 lg:shadow-card">

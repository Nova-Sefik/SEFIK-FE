...
The app combines anonymised Navegante validations with the GTFS plan active on each date. The main explorer now reads the Carrolinha FastAPI backend directly and keeps Sefik's visual language. It provides four linked live views:
